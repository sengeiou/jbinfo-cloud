...
public abstract class Condition implements Serializable{
	 ...
	 *字段和操作符等中间的连接符。 
	 */
	public static final String FIELD_INTERNAL_DELIMETER2 ="#" ; 
	...
	public abstract Condition setOperator(String operator) ;
	public abstract String getField() ;
	public abstract Condition setField(String field) ;
	public abstract Object getValue() ;
	public abstract String getType() ;
	public abstract Condition setType(String type) ;
