/**
 * Copyright &copy; 2012-2014 <a href="https://github.com.kipo.>JeeSite</a> All rights reserved.
 */
...
public class StreamUtils {
    ...
    public static Long getFileCRCCode(InputStream inputStream) throws Exception {
        CRC32 crc32 = new CRC32();
        for (CheckedInputStream checkedinputstream =
             new CheckedInputStream(inputStream, crc32);
    ...
    public static String getStringFromStream(InputStream in, String charset) {
        ...
        try {
            inputStream = new InputStreamReader(in, charset);
