...
/**
 * Created by xiaobin on 2017/8/22.
 */
public class DecimalCalculate {
    ...
    public static BigDecimal toDecimal(Float b){
        return safeAdd(new BigDecimal(b),new BigDecimal(0));
    }
    ...
    public static Integer safeAdd(Integer b1, Integer... bn) {
        ...
        if (null != bn) {
            for (Integer b : bn) {
                r += java.util.Optional.ofNullable(b).orElse(0);
            }
        }
        return r > 0 ? r : 0;
    }
