...
/**
 * 基于Spring RestTemplate的工具类
 * Created by xiaobin on 16/7/14.
 */
public class HttpPoolClientBuilder {
    ...
    public static HttpComponentsClientHttpRequestFactory getHttpClientFactory() {
